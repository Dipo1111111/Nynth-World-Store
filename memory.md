...
- "Tickets part doesn't send anything related to the ticket or event" was interpreted as the confirmation emails lacking event info (now fixed). No seat/row/format ask from Newman's screenshot yet.
