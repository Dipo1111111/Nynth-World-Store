...
const PAYMENT_STATUS_CONFIG = {
 paid: { label: "Paid", className: "bg-gray-50 text-green-500 border-emerald-100" },
 pending: { label: "Pending", className: "bg-gray-50 text-gray-600 border-amber-100" },
 failed: { label: "Failed", className: "bg-gray-50 text-red-500 border-red-100" },
...
const PaymentStatusDropdown = ({ status, onStatusChange }) => {
 ...
 <span className={`w-2 h-2 rounded-lg ${cfg.className.split(' ')[0]}`} />
 {cfg.label}
 </span>
 </SelectItem>
 ))}
